...
You can either have your dataset in a supported format (csv/jsonlines/json/parquet/txt), or use a dataset script to define how to load your data.
...
- a `your_dataset_name.py` file, which is the dataset script (optional if your data files are already in the supported formats csv/jsonlines/json/parquet/txt);
...
You can find more information about each section in the `Dataset Card guide <https://github.com/huggingface/datasets/blob/master/templates/README_guide.md>`.
